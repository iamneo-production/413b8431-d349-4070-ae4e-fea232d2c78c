...
const EditTask = () => {
    ...
    try {
      Swal.fire({
        ...
        if(result.isConfirmed){
          await axios.put(`https://8080-edfdbecdceefbfbcdcaeeaebabeaeaadbdbabf.project.examly.io/task/${id}`, formData);
           navigate("/tasks");
          Swal.fire(
            'Changes saved!',
  ...
  const loadTask = async () => {
    try {
      const response = await axios.get(`https://8080-edfdbecdceefbfbcdcaeeaebabeaeaadbdbabf.project.examly.io/task/${id}`);
