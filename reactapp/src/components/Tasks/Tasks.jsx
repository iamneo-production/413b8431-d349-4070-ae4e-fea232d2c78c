...
const Tasks = ({ tasks }) => {
  ...
  const loadTask = async () => {
    try{
      const response = await axios.get("https://8080-afeeccafebfbbcdcaeeaebabeaeaadbdbabf.project.examly.io/task");
      ...
      try {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            await axios.delete(`https://8080-afeeccafebfbbcdcaeeaebabeaeaadbdbabf.project.examly.io/task/${id}`);
