...
const EditCustomer = () => {
    ...
    try {
      Swal.fire({
        ...
        if(result.isConfirmed){
          await axios.put(`https://8080-edfdbecdceefbfbcdcaeeaebabeaeaadbdbabf.project.examly.io/customer/${id}`, formData);   
           navigate("/customers");
  ...
  const loadCustomer = async () => {
    try {
      const response = await axios.get(`https://8080-edfdbecdceefbfbcdcaeeaebabeaeaadbdbabf.project.examly.io/customer/${id}`);
