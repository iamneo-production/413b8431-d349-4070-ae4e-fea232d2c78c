...
const EditTicket = () => {
    ...
    function onChangeData(e) {
        ...
        try {
          Swal.fire({
            ...
            if(result.isConfirmed){
              await axios.put(`https://8080-afeeccafebfbbcdcaeeaebabeaeaadbdbabf.project.examly.io/ticket/${id}`, formData);
              navigate("/tickets");
      ...
      const loadTicket = async () => {
        try {
          const response = await axios.get(`https://8080-afeeccafebfbbcdcaeeaebabeaeaadbdbabf.project.examly.io/ticket/${id}`);
