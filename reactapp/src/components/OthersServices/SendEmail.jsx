...
const SendEmail = () => {
  ...
  const fetchEmails = async () => {
    await axios
      .get("https://8080-afeeccafebfbbcdcaeeaebabeaeaadbdbabf.project.examly.io/getemails")
      .then((response) => {
  ...
  async function sendEmailHandler(e) {
    ...
    try {
      await axios.post("https://8080-afeeccafebfbbcdcaeeaebabeaeaadbdbabf.project.examly.io/send", formDataToSend);
