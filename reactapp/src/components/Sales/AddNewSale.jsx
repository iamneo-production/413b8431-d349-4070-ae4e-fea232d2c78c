...
const AddSales = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      await axios.post(`https://8080-edfdbecdceefbfbcdcaeeaebabeaeaadbdbabf.project.examly.io/customer/${formData.customer_id}/opportunity/${formData.opportunity_id}/sale`,
      formData);
      // navigate("/sales");
