...
const EditLead = () => {
    ...
    try {
      Swal.fire({
        ...
        if(result.isConfirmed){
          await axios.put(`https://8080-afeeccafebfbbcdcaeeaebabeaeaadbdbabf.project.examly.io/lead/${id}`, formData);
    navigate("/leads");
  ...
  const loadLead = async () => {
    try {
      const response = await axios.get(`https://8080-afeeccafebfbbcdcaeeaebabeaeaadbdbabf.project.examly.io/lead/${id}`);
