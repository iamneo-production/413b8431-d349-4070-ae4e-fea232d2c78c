...
const Leads = ({ leads }) => {
  ...
  const loadCustomer = async () => {
    try {
      const response = await axios.get("https://8080-afeeccafebfbbcdcaeeaebabeaeaadbdbabf.project.examly.io/lead");
    ...
    try {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          await axios.delete(`https://8080-afeeccafebfbbcdcaeeaebabeaeaadbdbabf.project.examly.io/lead/${id}`);
